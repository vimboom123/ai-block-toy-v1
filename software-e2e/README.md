...
- run both the built-in package fixtures and the materialized prep fixtures under `../03-software-e2e-prep/fixtures`
- keep `../03-software-e2e-prep/` as fixture source bank only, not as a separate runnable runner
...
- do not use `../03-software-e2e-prep/run_e2e.py` for normal execution anymore
...
Run the phase-3 prep fixture set:
...
Run every built-in + phase-3 prep fixture in one sweep:
...
Notes:
- `03-software-e2e-prep/run_e2e.py` is archived and now only redirects you back here.
